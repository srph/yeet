...
import { HomeDefaultHeadline } from "./home-default-headline";
      ...
      <form onSubmit={onSubmit}>
        <div className="relative">
          <input
            ...
            autoFocus
            className="w-full rounded-full border border-neutral-700 bg-neutral-800 py-3 pl-4 pr-28 text-sm font-medium outline-none transition placeholder:text-neutral-500 focus:border-blue-200 focus:ring-1 focus:ring-blue-200"
          />
