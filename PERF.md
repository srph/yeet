...
**Next:** in-repo leftovers are 4c (dead Playfair CSS) and maybe lazy-loading tracking. Phase 3 still needs Cloudflare/Forge. First-load LCP is still JS-bound; phase 1 was the only ≥200ms move.
